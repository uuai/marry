  ...
  <div class="ReleasePhoto">
    ...
    <div class="Release-wrap">
      ...
      <div class="unpload">
        ...
        <ul class="fileUpWrap">
          <li v-for="(item,index) in fileUp" :key="index" class="fileImg"><img :src="item" alt=""></li>
          <li class="fileImg">
      ...
      <ul class="releaseType">
        <li v-for="(item,index) in releaseType" @click="onRelease(index)" :class="typeIndex==index?'ontype':''" :key="index">{{item}}</li>
      </ul>
    </div>
    <div class="temp"></div>
    ...
    export default {
      ...
      data() {
        return {
          ...
          desc: '',
          fileUp: [
            require("../../../static/img/del/flow1.png"),
            require("../../../static/img/del/flow2.png"),
            require("../../../static/img/del/flow3.png"),
          ],
          chooseIndex: 0,
          typeIndex: 0,
...
<style scoped>
  ...
  .ReleaseChoose>.btnactive,.releaseType>.ontype{
    background: #e55583;
    color: #fff;
  }
  .releaseType {
